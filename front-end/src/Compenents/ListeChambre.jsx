...
export default function ListeChambre()
    {
      ...
      const [Back_up, setBack_up] = useState([]);
        ...
        async function DeleteChamber(NumChamb) {
                        ...
                        <div class="card">
                          ...
                          <div class="card-body">
                            ...
                            <div class="d-flex flex-row justify-content-between">
                              ...
                              <Link
                                  class="btn btn-light btn-rounded"
                                  to={`/UpdateChambre/${element.NumChamb}/${IdCl}`}
                                  >Update chambre
                              </Link>
                              <button class="btn btn-light btn-rounded"  onClick={()=>DeleteChamber(element.NumChamb)}>
                              Delete
                              </button>
